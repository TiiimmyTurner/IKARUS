...
new Promise((resolve)=> {
    MTLLoader.load('https://raw.githubusercontent.com/TiiimmyTurner/IKARUS/master/IKARUS-DESKTOP/resources/sonde.mtl', (materials)=>{
        resolve(materials);
    })
}).then((materials) => {
        materials.preload(); //optional
        OBJLoader.setMaterials(materials);
        OBJLoader.load('https://raw.githubusercontent.com/TiiimmyTurner/IKARUS/master/IKARUS-DESKTOP/resources/sonde.obj',
        (object) => {
        cube = object;
        scene.add(object);
    })
